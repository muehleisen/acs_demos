...
h=plot(x,y,colorspec,'markersize',dotsize,'markerfacecolor','k');
...
for I=1:Nframes
    ...
    dx=-A*sin(k.*x-w.*t(I));
	subplot(2,1,1)
 	h=plot(x+dx,y,colorspec,'markersize',dotsize,'markersize',dotsize,'markerfacecolor','k');

	%h=plot(x+dx,y,'linestyle','none','markerfacecolor',colorspec,'marker',markerspec,'markersize',dotsize);
    axis([-L/10,L,0,W])
    ...
    text(-L/6,1,'Max','fontsize',fontsize)
    text(-L/6,-1,'Min','fontsize',fontsize)
