...
ABS audience = <56 68 79 85 86 86 > L <30 40 50 60 70 80> {128 128 0}  ; audience for light upholstery from Beranek

;STEP 1: audience and floor surfaces
;ABS audience = <35 50 55 70 85 80> L <30 40 50 60 70 80> {128 128 0}
ABS floorabs = parquet
...
GLOBAL fsd = 2   ; front-stage depth
GLOBAL fsw = 16   ; front-stage width
GLOBAL sw  = fsw + 2 ; stage width
GLOBAL pw  = 2   ; prosc. width
GLOBAL w   = 20  ; max hall width
GLOBAL ew  = 2 ; entrance width
GLOBAL fld = 3   ; flank depth
GLOBAL flt = 1   ; floor tilt
GLOBAL wl1 = 10   ; first side wall length
GLOBAL wl2 = 12   ; second side wall length
GLOBAL hd  = fld + wl1 + wl2 ; hall depth from prosc

;STEP 2: ceiling, backwall, sidewalls
GLOBAL h   = 15   ; hall height
GLOBAL mh  = h+3  ; mid hall height
GLOBAL bh  = h+2	;  back hall height
